...
data.forEach((record) => {
  ...
  const parts = [];
  parts.push(record.Rainfall !== undefined ? record.Rainfall : 0);
  parts.push(record.Pressure3pm !== undefined ? record.Pressure3pm : 0);

  if (options.humidity) {
    parts.push(record.Humidity3pm !== undefined ? record.Humidity3pm : 0);
  }
